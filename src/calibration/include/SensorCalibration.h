...
class SensorCalibration
{
    ...
    private:
        ...
        Eigen::RowVector2d ComputeDisp(const Eigen::Ref<const Eigen::MatrixX2d> &cluster, const Eigen::Ref<const Eigen::Vector2d> &mean) const;
        void UpdateCsv(std::ofstream &csvFile, const Eigen::Ref<const Eigen::MatrixX2d> &disp) const;
